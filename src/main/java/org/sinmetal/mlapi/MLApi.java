...
public class MLApi {
    ...
    public static void main(String[] args) {
        ...
        table.setProjectId("sinmetal");
        table.setDatasetId("hoge");
        table.setTableId("MessageShort");

        List<TableFieldSchema> fields = new ArrayList<>();
        fields.add(new TableFieldSchema().setName("DLPResponse").setType("STRING"));
        TableSchema schema = new TableSchema().setFields(fields);

        TableReference tableRef = new TableReference();
        tableRef.setProjectId("sinmetal");
        tableRef.setDatasetId("hoge");
        tableRef.setTableId("DLPMessageShort");
